...
export const CharacterIcon: React.FC<IconProps> = ({ className }) => (
...
export const MonsterIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M20.34 17.66 12 22l-8.34-4.34A2 2 0 0 1 2 15.97V8.03a2 2 0 0 1 1.66-1.97L12 2l8.34 4.06a2 2 0 0 1 1.66 1.97v7.94a2 2 0 0 1-1.66 1.97Z"></path>
        <path d="M12 2v20"></path>
        <path d="m5 8 7 4"></path>
        <path d="m19 8-7 4"></path>
        <path d="m5 16 7-4"></path>
        <path d="m19 16-7-4"></path>
    </svg>
);

export const BattleIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m3.5 3.5 17 17L12 22V2Z"></path>
        <path d="m20.5 20.5-17-17L12 2v20Z"></path>
    </svg>
);
...
export const SourcesIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
